...
export default {
    ...
    setup(props, ctx) {
        ...
        const newTwootCharCount = computed(() => state.newTwootContent.length) // this was the computed section

        function createNewTwoot() { //this was the methods - they are now functions
